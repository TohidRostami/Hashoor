    ...
    <div className="flex h-full flex-col text-sidebar-foreground px-2">
      ...
      <nav className="flex flex-1 flex-col gap-0.5 px-3">
        ...
        <button
          ...
          className="flex items-center gap-3 rounded-md px-3 py-2.5 text-sm text-black transition-colors hover:bg-sidebar-accent/60 hover:text-sidebar-foreground"
        >
